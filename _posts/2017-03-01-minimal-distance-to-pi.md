...
1. Suppose the last interval is $$(a/b,c/d)$$. Cut it by the [mediant](https://en.wikipedia.org/wiki/Mediant_(mathematics)) of $$a/b$$ and $$c/d$$ and choose one of the intervals $$(a/b,(a+c)/(b+d))$$, $$((a+c)/(b+d),c/d)$$ that contains $$\theta$$ as the next interval.
...
{% include helpers/image.html name="trapezoid.png" caption="Figure 1: Geometric interpretation" %}
